...
internal static partial class Log
{
    ...
    [LoggerMessage(EventId = 1003, Level = LogLevel.Information, Message = "Searching images for '{ObjectDescription}'")]
    public static partial void SearchingImages(ILogger logger, string objectDescription);

    [LoggerMessage(EventId = 1004, Level = LogLevel.Warning, Message = "No images found for '{ObjectDescription}'")]
    public static partial void NoImagesFound(ILogger logger, string objectDescription);
